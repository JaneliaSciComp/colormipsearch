...
public class ImageDraw {
    ...
    public static <T extends Type<T>> void draw3dLine(RandomAccess<T> img,
                                                      int w, int h, int d,
                ...
                for (int i = 0; i <= iteration; i++) {
                    ...
                    if (ir1 == 0 && ir2 == 0) {
                        if (ix >= 0 && ix < w && iy >= 0 && iy < h && iz >= 0 && iz < d)
                            img.setPositionAndGet(ix, iy, iz).set(fgPx);
                    } else {
                        draw3dSphere(img, w, h, d, ix, iy, iz, r1 + dr * i * sign, zratio, fgPx);
                    }
                }
                break;
            case 1:
    ...
    private static <T extends Type<T>> void draw3dSphere(RandomAccess<T> img,
                                                         int w, int h, int d,
                                                         int x, int y, int z,
                ...
                for (int dx = -ir; dx <= ir; dx++) {
                    ...
                    if (dd <= r * r) {
                        if (xx >= 0 && xx < w && yy >= 0 && yy < h && zz >= 0 && zz < d)
                            img.setPositionAndGet(xx, yy, zz).set(fgPx);
                    }
                }
            }
        }
